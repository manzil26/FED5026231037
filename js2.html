    ...
    <head>
        ...
        <script>
            function formvalidation()
            {
                ...
                if (nrp.length == 0)
                {
                    // ini pakai web https://sweetalert2.github.io/
                    // menggunakan A title with a text under
        ...
        <div class="container">
            ...
            <form id="frmpendaftaran" action="https://google.co.id" method="get"
                ...
                NRP : <input type="text" id="nrp" class="form-control"
                    placeholder="Silakan isi NRP , 10 digit , harus angka , gak boleh kosong"
                    name="nrp">
                <br>
                Nama : <input type="text" id="nama" class="form-control"
                    placeholder="Silakan isi nama , minim 1 digit , gak boleh kosong"
                    name="nama">
                <br>
